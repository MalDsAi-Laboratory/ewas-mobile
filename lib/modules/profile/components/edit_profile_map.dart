...
class EditProfileMapScreen extends StatefulWidget {
  @override
  _EditProfileMapScreenState createState() => _EditProfileMapScreenState();
}

class _EditProfileMapScreenState extends State<EditProfileMapScreen> {
  TextEditingController _searchController = TextEditingController();
  List<dynamic> _searchResults = [];

  final MapController _mapController = MapController();
  bool _showSearchResults = false;
  final ProfileController locationController = Get.find<ProfileController>();
